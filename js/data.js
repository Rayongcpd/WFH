      ...
      <div style="margin-bottom:20px;padding:16px;background:var(--card-bg);border-radius:12px;border:1px solid var(--border);">
        <div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;">
          ...
          <div style="flex:1;min-width:200px;">
            ...
            <div style="font-size:0.8rem;color:var(--gray);line-height:1.5;">ลงเวลาเข้า/ออกงาน<strong>อัตโนมัติ</strong>ตามวันที่เลือก<br>สุ่มเวลาเข้า 07:30-08:00 / ออก 16:30-17:00</div>
